  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow p-6 mb-6">
        ...
        <p className="mb-4">
          Language Translator is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our translation service.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow p-6 mb-6">
        ...
        <p className="mb-4">
          Language Translator uses third-party AI providers (such as OpenAI, Groq, and OpenRouter) to process translations and speech. Text submitted for translation may be sent to these providers according to their respective privacy policies.
        </p>
      </div>
