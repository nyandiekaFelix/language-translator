  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow p-6 mb-6">
        ...
        <p className="mb-4">
          By using Language Translator, you agree to these Terms and Conditions. If you do not agree, please do not use this service.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow p-6 mb-6">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>Language Translator is provided for personal and non-commercial use.</li>
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow p-6 mb-6">
        ...
        <p className="mb-4">
          Language Translator is open-source software licensed under the MIT License. You may use, modify, and distribute the software in accordance with the license terms.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow p-6 mb-6">
        ...
        <p className="mb-4">
          To the fullest extent permitted by law, Language Translator and its contributors are not liable for any damages arising from the use or inability to use this service.
        </p>
      </div>
    </div>
  );
