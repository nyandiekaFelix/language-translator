...
const About = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6 text-center text-secondary-800 dark:text-secondary-200">About Language Translator</h1>

      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4">What is Language Translator?</h2>
        <p className="mb-4">
          Language Translator is an open-source translation tool that leverages Large Language Models (LLMs) to provide high-quality translations between multiple languages. This frontend application is built with React and Vite, providing a modern user interface for interacting with the translation service.
        </p>
        <p className="mb-4">
          Unlike traditional translation services, Language Translator can better understand context, idioms, and cultural nuances, resulting in more natural and accurate translations.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow p-6 mb-6">
        ...
        <p className="mb-4">
          Language Translator is built with modern web technologies:
        </p>
        <ul className="list-disc pl-5 space-y-2">
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow p-6">
        ...
        <p className="mb-4">
          Language Translator is an open-source project. Contributions, bug reports, and feature requests are welcome
        </p>
        <p>
          <a
            href="https://github.com/nyandiekaFelix/language-translator"
            target="_blank"
