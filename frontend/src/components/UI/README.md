...
This directory contains reusable UI components for the Language Translator frontend. These components are designed to provide consistent, accessible, and theme-aware UI elements across the application. They leverage Material UI (MUI) v7.1.0 and custom styling conventions, including Tailwind CSS variables for color and spacing.
